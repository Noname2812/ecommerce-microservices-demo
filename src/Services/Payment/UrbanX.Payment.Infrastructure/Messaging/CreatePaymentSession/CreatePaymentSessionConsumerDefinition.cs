...
public sealed class CreatePaymentSessionConsumerDefinition : ConsumerDefinition<CreatePaymentSessionConsumer>
{
    private readonly CreatePaymentSessionConsumerOptions _options;

    public CreatePaymentSessionConsumerDefinition(IOptions<CreatePaymentSessionConsumerOptions> options)
    {
    ...
    protected override void ConfigureConsumer(
        ...
        IConsumerConfigurator<CreatePaymentSessionConsumer> consumerConfigurator,
