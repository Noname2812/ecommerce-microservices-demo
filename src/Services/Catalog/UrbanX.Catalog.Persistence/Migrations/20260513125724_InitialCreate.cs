        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeletedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    ProjectionVersion = table.Column<int>(type: "integer", nullable: false),
                    NameNormalized = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false, defaultValue: ""),
                    SkuNormalized = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false, defaultValue: ""),
                    search_vector = table.Column<NpgsqlTsVector>(type: "tsvector", nullable: true, computedColumnSql: "to_tsvector('simple', coalesce(name_normalized,'') || ' ' || coalesce(sku_normalized,'') || ' ' || coalesce(array_to_string(tags,' '),''))", stored: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "ix_plv_name_normalized_trgm",
                schema: "read",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_plv_sku_normalized_trgm",
                schema: "read",
                table: "product_list_view",
