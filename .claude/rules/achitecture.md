...
builder.Services
    ...
    .AddMessaging(configureBus: bus =>    // khai báo MT EF outbox + consumers ở đây
    {
...
<!-- Thêm nếu cần: Shared.Contract, Shared.Cache -->
...
<ProjectReference Include="<Service>.Domain" />
<!-- Shared.* theo adapter: Contract, Cache, … -->
```
...
<!-- Thêm nếu cần: <Service>.Infrastructure, <Service>.Domain -->
```
